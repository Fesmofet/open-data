...
**Status:** Accepted  
**Date:** 2026-03-11  
**Context:** [Services architecture](../overview.md), [PostgreSQL data model](../../spec/data-model/flow.md). (MongoDB v2 was an evaluated alternative; comparison sections remain in the data-model doc.)
...
- **Mongo concept v2** — six collections, projection collection required for searchability (see comparison in [data-model/flow.md](../../spec/data-model/flow.md))
- **PostgreSQL** — five tables, no projection table, query core tables directly ([data-model/flow.md](../../spec/data-model/flow.md))
...
- [data-model/flow.md](../../spec/data-model/flow.md) — full PostgreSQL schema, write/read flows, index strategy, comparison table
- [acceptance-tests.md](../../spec/acceptance-tests.md) — non-functional targets that informed the choice
- [Services architecture](../overview.md) — service boundaries
