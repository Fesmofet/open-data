...
**`light`** — default feed UI: page `#fafbfc`, cards `#ffffff`, text `rgba(0,0,0,0.84)` / secondary `#99aab5`, borders `#e9e7e7`, accent orange `#f87007` (`--color-accent`, `--color-link`, `--color-focus`) with alt `#fa9239` and hover `#d96205`, error `#f44336`. Medium-inspired typography: GT Super / Noe Display (`--font-display`), Sohne / Inter (`--font-body`), Charter (`--font-editorial`); scale 13px caption → 16px body → 20px lead → 22px section (weights 400 on display/body). Line heights ~1.27 / 1.43 / 1.54 / 1.58. Flat elevation: ring shadows only (`0 0 0 1px` border), 6px buttons / 8px cards, slightly tighter section spacing.
