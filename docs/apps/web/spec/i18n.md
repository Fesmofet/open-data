---
id: web-i18n
title: i18n — framework-free internationalization
description: Lightweight, framework-free i18n layer with no third-party i18n library. Locale resolution, messages, and UI wiring live under `apps/web/src/i18n/`.
type: spec
status: active
scope: web
tags: [web, i18n]
