...
- Node.js ≥ 20, pnpm (see [getting-started.md](../../getting-started.md))
...
See also the normative [gateway spec overview](spec/overview.md) (linked from the [spec index](../../spec/README.md)).
