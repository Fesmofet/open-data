...
| [object-favorite.md](object-favorite.md) | Favorites (`object_favorite`); heart action; `object_reputation`; governance `authorities` search scope |
| [object-ownership.md](object-ownership.md) | Ownership claims (`object_ownership` exclusive/supervised); curator filter for trusted tier |
| [authority-entity.md](authority-entity.md) | **Deprecated** — redirect stub to favorite + ownership specs |
