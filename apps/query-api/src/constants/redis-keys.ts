...
export const redisKey = {
  ...
  hiveRewardFund: () => buildRedisKey(APP, 'cache', 'reward-fund', 'hive'),
  hiveAccount: (accountName: string) =>
    buildRedisKey(APP, 'cache', 'hive', 'account', accountName.trim().toLowerCase()),
