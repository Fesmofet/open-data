...
registry.registerPath({
  ...
  description:
    'Thin proxy over `condenser_api.get_account_history` for the profile activity tab. Returns raw operation type and payload; presentation is owned by the web app. `effective_comment_vote` operations are excluded. Cursor encodes the next Hive `from` operation index.',
  request: {
