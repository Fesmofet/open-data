...
export default async function BusinessRequestsNewPage() {
  ...
  if (result.ok) {
    redirect(businessRoutes.offerDraft('request', result.value.draftId));
  }
  redirect(businessRoutes.manageRequests);
}
