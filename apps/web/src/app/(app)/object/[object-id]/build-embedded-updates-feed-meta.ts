...
import { parseObjectUpdatesSearchParams } from '@/modules/object-updates/application/parse-object-updates-search-params';
...
export function buildEmbeddedUpdatesFeedMeta(
  ...
  const localeOptions = [...model.updateLocales].sort((a, b) => a.localeCompare(b));
