...
export default async function BusinessOfferDraftPreviewPage({
  params,
}: {
  ...
  if (draft.kind === 'request') {
    redirect(businessRoutes.offerDraftPreview('request', draftId));
  }
  ...
  return (
    <div className="mx-auto max-w-container-narrow px-gutter py-section-y">
      <div className="mb-section-y flex flex-wrap items-center justify-between gap-3">
        <Link
          href={businessRoutes.offerDraft('offer', draftId)}
