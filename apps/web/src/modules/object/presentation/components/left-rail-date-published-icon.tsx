/** Publication date icon (legacy Waivio / Ant Design `calendar` glyph). */
export function LeftRailDatePublishedIcon() {
  return (
    <span
      className="inline-flex size-4 shrink-0 items-center justify-center text-fg"
      aria-hidden
    >
      <svg
        width="16"
