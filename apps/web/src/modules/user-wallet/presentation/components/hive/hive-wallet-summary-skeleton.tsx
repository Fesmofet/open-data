export function HiveWalletSummarySkeleton() {
  return (
    ...
    >
      <div className="flex items-start gap-2 border-b border-border px-3 py-3 sm:gap-4 sm:px-card-padding sm:py-4 [background-color:color-mix(in_srgb,var(--color-error)_7%,transparent)]">
